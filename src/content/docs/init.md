...
`faramesh init` **never** starts the daemon. It only writes files. It refuses to overwrite an existing `governance.fms` (exit 1) — delete the file or pick a new directory if you want to reinitialize.
