---
title: Faramesh Docs
description: Every agent gets an identity. Every tool call gets a policy decision. Every action gets a tamper-evident record.
---
...
<HomeSection label="Start here" intro="Install Faramesh and run a governed agent.">
	<HomeGrid cols={2}>
		<HomeCard
			href="/quickstart/"
			title="Quickstart"
	...
	<p class="home-section__more">
		<a href="/concepts/how-it-works/">Learn about Faramesh concepts →</a>
	</p>
</HomeSection>

<HomeSection label="Build with Faramesh" intro="Pick the wiring tier that matches your agent runtime.">
	<HomeGrid cols={3}>
		<HomeCard
	...
	<p class="home-section__more">
		<a href="/frameworks/">See every framework →</a>
	</p>
</HomeSection>

<HomeSection label="Concepts" intro="What's actually happening inside the daemon.">
	<HomeGrid cols={2}>
		<HomeCard
		...
		<HomeCard
			...
			title="Identity"
			icon="◉"
			body="SPIFFE / SVID, IDP attestation, the agent identity that scopes every credential and rule. Workload identity for AI agents."
		/>
		<HomeCard
...
<HomeSection label="CLI & SDKs" intro="The CLI is the primary interface. The SDKs wire it into your agent.">
	<HomeGrid cols={2}>
		<HomeCard
			href="/cli/"
			title="Faramesh CLI"
		...
		<HomeCard
			...
			title="Node SDK"
			icon="N"
			body="governedTools() for the AI SDK, Mastra, and custom Node runtimes. ToolDeniedError with the same payload shape."
		/>
	</HomeGrid>

	<p class="home-section__more">
		<a href="/cli/">CLI reference →</a> &nbsp;
		<a href="/fpl/">FPL reference →</a> &nbsp;
		<a href="/stack/">Stack reference →</a>
	</p>
</HomeSection>
...
<HomeSection label="Use cases" intro="Production patterns we see most often. Full policy snippets for each.">
	<HomeGrid cols={3}>
		<HomeCard
	...
	<p class="home-section__more">
		<a href="/use-cases/">See every pattern →</a>
	</p>
</HomeSection>
