...
<HomeSection label="CLI & SDKs" intro="The CLI is the primary interface. The SDKs wire it into your agent.">
	<HomeGrid cols={2}>
		...
		<HomeCard
			...
			icon="T"
			body="governedTools() for Mastra, the Vercel AI SDK, LangGraph.js, and OpenAI Agents JS. Works in Node, Workers, and Lambda. ToolDeniedError with the same payload shape."
		/>
	</HomeGrid>
